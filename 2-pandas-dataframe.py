...
print("\n colunaidade:") #retorna uma series:"estrutura de coluna do pandas"
print(df["idade"])
...
#retorna um novo data frame que com linhas que satisfazem a condição\corrija sem alterar nenhuma das #
...
df2=pd.dataframe(dados,colums=["nome","idade","salario"])
print("\n outro dataframe:")
print(df2)
